...
public class Log
{
    ...
    public static void Error(System.Exception exception, MethodBase methodBase, ref string
   pMensaje)
    {
        ...
        {
            msg.AppendFormat("{0}\n", DbException(exception as DbUpdateException, methodBase,
           ref pMensaje));
    ...
    private static string GetDetailsSQLException(SqlException pExcepcion)
    {
        ...
        msg.AppendFormat("\n");
        msg.AppendFormat("StackTrace {0}\n\n", pExcepcion.StackTrace);
        msg.AppendFormat(@"Info de errores para investigar mas
https://technet.microsoft.com/en-us/library/cc645603(v=sql.105).aspx");
 ...
 break;
            case 18452: //Login failed for user '%ls'. Reason: Not associated w trusted SQL Server connection.
